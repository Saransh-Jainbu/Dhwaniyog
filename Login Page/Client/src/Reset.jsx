...
const Reset = () => {
  return (
    ...
    <div className='flex w-screen h-[80vh] justify-center items-center'>
        ...
        <button className='flex mr-40 bg-[#FF685B] py-2.5 px-5 items-center rounded-md tracking-wide font-bold font-montserrat text-white text-sm not-italic space-x-2.5 mb-4 '>Next
