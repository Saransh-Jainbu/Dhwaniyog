   ...
   <>
    <div className="flex">
        ...
        <div className="flex flex-col p-2 mt-12 w-[850px] ml-[380px] ">
          ...
          <textarea type="text" placeholder="Type your suggestions here" className="border-2 p-4 mt-4 h-[20vh] w-[70vh] mb-2"></textarea>
          ...
          <textarea type="text" placeholder="Type your suggestions here" className="border-2 p-4 mt-4 h-[20vh] w-[70vh] mb-8"></textarea>
