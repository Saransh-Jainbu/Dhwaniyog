...
const Navbar = () => {
  ...
  return (
    <div className='flex p-4 mt-4 justify-between'>
      ...
      <button onClick={() => navigate("/login")} className='flex mr-40 bg-[#FF685B] py-2.5 px-5 items-center rounded-md tracking-wide font-bold font-montserrat text-white text-sm not-italic space-x-2.5'>
        <span>Login</span>
