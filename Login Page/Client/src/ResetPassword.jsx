    ...
    <>
      ...
      <div className="flex w-screen h-[80vh] justify-center items-center">
        <div className="flex flex-col items-start justify-center">
          ...
          />
          <button onClick={()=>navigate("/recovery")} className="flex mr-40 bg-[#FF685B] py-2.5 px-5 items-center rounded-md tracking-wide font-bold font-montserrat text-white text-sm not-italic space-x-2.5 mb-16 ">
            Reset
            <svg
